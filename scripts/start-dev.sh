...
echo ""
echo "Next steps:"
echo "  1. Start backend:  PYTHONPATH=/g/code/pixsim7 python pixsim7_backend/main.py"
echo "  2. Start worker:   PYTHONPATH=/g/code/pixsim7 arq pixsim7_backend.workers.arq_worker.WorkerSettings"
