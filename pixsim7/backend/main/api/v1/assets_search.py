...
def _build_search_filters(request: AssetSearchRequest) -> AssetSearchFilters:
    ...
    return AssetSearchFilters(
        ...
        upload_source_folder_id=request.upload_source_folder_id,
        upload_source_subfolder=request.upload_source_subfolder,
        source_siblings_of_asset_id=request.source_siblings_of_asset_id,
...
async def search_assets(
    ...
    try:
        ...
        # counts are no longer computed inline — the hover-gated badge fetches
        # them lazily from /assets/{id}/cohort-counts.
