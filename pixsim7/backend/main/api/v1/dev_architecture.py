...
def load_frontend_app_map() -> Dict[str, Any]:
    ...
    The app_map.generated.json is created by scripts/generate-app-map.ts
    which parses frontend module definitions and extracts appMap metadata.
    """
...
async def get_frontend_architecture(
    ...
    This data is derived from frontend module definitions (page.appMap)
    and generated by scripts/generate-app-map.ts.
