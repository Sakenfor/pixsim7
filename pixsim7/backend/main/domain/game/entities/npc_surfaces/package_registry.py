...
class NpcSurfacePackageRegistry(
    SimplePackRegistryBase[str, str, Dict[str, Any], NpcSurfacePackage]
):
    """
    Registry for NPC surface packages.

    Extends SimplePackRegistryBase with surface-specific query methods.
    """
