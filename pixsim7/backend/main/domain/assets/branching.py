"""Domain models for branching and clip metadata.

These models track:
- Branch points where videos pause and create multiple variants
- Variants that link branches to outcome assets
- Clips for temporal extraction from assets

Used for game integration (choice points, conditional paths) and video editing.
"""
