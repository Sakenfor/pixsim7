...
class ProviderCredit(SQLModel, table=True):
    ...
    def get_display_name(cls, credit_type: str, provider_id: str) -> str:
        ...
        Note: This is a convenience method. For canonical credit type info,
        use CreditSemantics from the credits module.
        """
        # Import here to avoid circular dependency
        from pixsim7.backend.main.domain.providers.credits import get_credit_display_name
        return get_credit_display_name(credit_type, provider_id)
