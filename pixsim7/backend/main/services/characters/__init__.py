...
Note: Some services have moved to more appropriate locations:
- CharacterNPCSyncService: services.npc.character_sync
- PromptContextService: services.prompt.context.resolver
- Field mappings: services.prompt.context.mappings
"""
