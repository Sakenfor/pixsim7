...
Tools are provided by separate plugins:
- touch-tools: hand-3d, caress, silk
- sensation-tools: feather, pleasure

This plugin handles the API endpoints and interactions.
"""
...
manifest = PluginManifest(
    ...
    version="5.0.0",  # v5: Tools moved to separate plugins (touch-tools, sensation-tools)
    ...
    # Note: Tools are now in separate plugins (touch-tools, sensation-tools)
    frontend_manifest={
        "pluginId": "romance",
