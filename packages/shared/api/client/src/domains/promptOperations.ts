/**
 * Prompt Operations domain client (op runtime executor).
 *
 * Wraps `POST /api/v1/prompts/operations/execute`. Phase 2 of
 * plan:op-runtime-span-popover. Types are hand-authored here; once the
 * backend OpenAPI spec is regenerated they can be swapped for the
 * generated `@pixsim7/shared.api.model` shapes.
 */
...
export function createPromptOperationsApi(client: PixSimApiClient) {
  return {
    async execute(request: OpExecuteRequest): Promise<OpExecuteResponse> {
      return client.post<OpExecuteResponse>(
