...
// Domain clients
export { addInventoryItem, addQuest, advanceGameWorldTime, attemptPickpocket, attemptSensualTouch, buildPrimitiveSelectionRequestFromBehavior, clearInventory, completeObjective, createGameObject, createGameSession, createGameWorld, deleteProjectDraft, deleteSavedGameProject, duplicateSavedGameProject, exportWorldProject, getGameLocation, getGameObject, getGameScene, getGameSession, getGameWorld, getInventoryItem, getInventoryStats, getNpcDetail, getNpcExpressions, getNpcPresence, getNpcSlots, getProjectDraft, getSavedGameProject, getSessionQuest, getWorldConfig, getWorldManifest, getWorldNpcRoles, importWorldProject, listGameLocations, listGameNpcs, listGameObjects, listGameSessions, listGameWorlds, listInventoryItems, listNpcSurfacePackages, listSavedGameProjects, listSessionQuests, removeInventoryItem, renameSavedGameProject, resolveTemplate, resolveTemplateBatch, saveGameLocationHotspots, saveGameLocationMeta, saveGameProject, saveGameWorldMeta, saveNpcExpressions, saveNpcMeta, selectPrimitiveBlocksFromBehavior, setNpcSlots, setWorldManifest, setWorldNpcRoles, updateGameObject, updateGameSession, updateGameWorldMeta, updateInventoryItem, updateObjectiveProgress, updateQuestStatus, upsertProjectDraft } from './game';
export type { PrimitiveSelectionRequestPayload, PrimitiveSelectionResponsePayload, BuildPrimitiveSelectionRequestFromBehaviorRequest, BuildPrimitiveSelectionRequestFromBehaviorResponse, DraftSummary, DuplicateSavedGameProjectRequest, GameHotspotDTO, GameLocationDetail, GameLocationSummary, GameNpcDetail, GameNpcSummary, GameObjectDetail, GameObjectSummary, GameObjectTemplateBinding, GameObjectWritePayload, GameProjectBundle, GameProjectImportResponse, GameSessionDTO, GameSessionSummary, GameWorldDetail, GameWorldSummary, InventoryItemDTO, InventoryStatsResponse, MessageResponse, NpcExpressionDTO, NpcPresenceDTO, NpcSlot2d, NpcSurfacePackage, PaginatedWorldsResponse, PickpocketRequest, PickpocketResponse, QuestDTO, QuestObjectiveDTO, RenameSavedGameProjectRequest, ResolveBatchResponse, ResolveTemplateResponse, SaveGameProjectRequest, SavedGameProjectDetail, SavedGameProjectSummary, SensualTouchRequest, SensualTouchResponse, SessionUpdatePayload, SessionUpdateResponse, TemplateKind, UpsertDraftRequest, WorldConfigResponse, WorldManifest } from './game';
...
export { adminDeactivateUser, adminUpdateUser, adminUpdateAgentProfileScope, listAdminAgentProfiles, listAdminUsers, listAdminUserWorlds, listAdminUserProjects, listScopePlanOptions, listScopeContractOptions, listBridgeMachines, updateAdminUserPermissions } from './adminUsers';
export type { AdminAgentProfile, AdminAgentProfilesResponse, AdminProfileScopeParams, AdminUpdateUserParams, AdminUserPermissions, AdminUsersListResponse, AdminWorldOption, AdminWorldOptionsResponse, AdminProjectOption, ScopeOption, BridgeMachine, BridgeMachinesResponse, ListAdminUsersParams, ListBridgeMachinesParams } from './adminUsers';
...
export type { ApplyPromptEditRequest, ApplyPromptEditResponse, PromptEditOp, PromptFamilyDetail, PromptFamilySummary, PromptVersionAssetsResponse, PromptVersionDetail, PromptVersionSummary } from './prompts';
