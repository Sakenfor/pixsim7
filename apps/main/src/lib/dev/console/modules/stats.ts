 ...
 *
 * Registers interaction stats operations with the console.
...
function registerStatsOps(): void {
...
function registerStatsData(): void {
  dataRegistry.register({
    id: 'interactionStats',
    name: 'Interaction Stats',
    description: 'Dynamic stats for NPC interactions',
    getSnapshot: () => useInteractionStatsStore.getState(),
    getKeys: () => ['stats', 'configs', 'customToolStats', 'isActive', 'history'],
  });
}
