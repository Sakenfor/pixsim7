...
import {
  ...
  Tags,
  ListFilter,
  // Expanded set glyph palette (shapes, nature, objects, faces, animals, food…)
  Flag,
  Bookmark,
  Boxes,
  Diamond,
...
export const Icons = {
  ...
  // Expanded set-glyph palette — shapes, nature, objects, faces, animals, food.
  // (Kebab aliases mirror the existing safety-net convention; the picker
  // collapses aliases so each glyph still shows once.)
  flag: Flag,
  bookmark: Bookmark,
  boxes: Boxes,
  diamond: Diamond,
