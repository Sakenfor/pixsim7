...
const COLOR_TOKENS: Record<string, ColorToken> = {
  blue: {
    ...
    inlineBg: 'bg-blue-200/80 dark:bg-blue-700/50',
    inlineHover: 'hover:bg-blue-300/90 dark:hover:bg-blue-600/60',
    hex: '#3b82f6',
  },
  green: {
    badge: 'bg-green-500',
    panel: 'bg-green-100 dark:bg-green-900/40 border-green-300 dark:border-green-700 text-green-800 dark:text-green-200',
    inlineBg: 'bg-green-200/80 dark:bg-green-700/50',
    inlineHover: 'hover:bg-green-300/90 dark:hover:bg-green-600/60',
    hex: '#22c55e',
  },
  purple: {
    badge: 'bg-purple-500',
    panel: 'bg-purple-100 dark:bg-purple-900/40 border-purple-300 dark:border-purple-700 text-purple-800 dark:text-purple-200',
    inlineBg: 'bg-purple-200/80 dark:bg-purple-700/50',
    inlineHover: 'hover:bg-purple-300/90 dark:hover:bg-purple-600/60',
    hex: '#a855f7',
  },
  yellow: {
    badge: 'bg-yellow-500',
    panel: 'bg-yellow-100 dark:bg-yellow-900/40 border-yellow-300 dark:border-yellow-700 text-yellow-800 dark:text-yellow-200',
    inlineBg: 'bg-yellow-200/80 dark:bg-yellow-700/50',
    inlineHover: 'hover:bg-yellow-300/90 dark:hover:bg-yellow-600/60',
    hex: '#eab308',
  },
  pink: {
    badge: 'bg-pink-500',
    panel: 'bg-pink-100 dark:bg-pink-900/40 border-pink-300 dark:border-pink-700 text-pink-800 dark:text-pink-200',
    inlineBg: 'bg-pink-200/80 dark:bg-pink-700/50',
    inlineHover: 'hover:bg-pink-300/90 dark:hover:bg-pink-600/60',
    hex: '#ec4899',
  },
  cyan: {
    badge: 'bg-cyan-500',
    panel: 'bg-cyan-100 dark:bg-cyan-900/40 border-cyan-300 dark:border-cyan-700 text-cyan-800 dark:text-cyan-200',
    inlineBg: 'bg-cyan-200/80 dark:bg-cyan-700/50',
    inlineHover: 'hover:bg-cyan-300/90 dark:hover:bg-cyan-600/60',
    hex: '#06b6d4',
  },
  orange: {
    badge: 'bg-orange-500',
    panel: 'bg-orange-100 dark:bg-orange-900/40 border-orange-300 dark:border-orange-700 text-orange-800 dark:text-orange-200',
    inlineBg: 'bg-orange-200/80 dark:bg-orange-700/50',
    inlineHover: 'hover:bg-orange-300/90 dark:hover:bg-orange-600/60',
    hex: '#f97316',
  },
  gray: {
    ...
    inlineBg: 'bg-neutral-200/80 dark:bg-neutral-700/50',
    inlineHover: 'hover:bg-neutral-300/90 dark:hover:bg-neutral-600/60',
    hex: '#64748b',
  },
};
