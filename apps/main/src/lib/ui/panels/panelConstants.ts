...
export function getCategoryColorClasses(category: PanelCategory): string {
  const colorMap: Record<PanelCategory, string> = {
    ...
    scene: 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300',
    ...
    utilities: 'bg-gray-100 text-gray-700 dark:bg-gray-700/30 dark:text-gray-300',
