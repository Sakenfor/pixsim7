 ...
 * DynamicParamForm
 *
 * Renders a dynamic form based on ParamSpec definitions.
 * Used to display provider-specific generation parameters.
 *
 * Features:
 * - Auto-groups parameters by category (core, render, style, advanced)
 * - Supports various field types: text, number, boolean, enum/select
 * - Shows validation state for required fields
