              ...
              <>
                ...
                {showAddEffect && (
                  <div className="border rounded p-3 bg-blue-50 dark:bg-blue-900/20 dark:border-blue-800 space-y-3">
                    <div>
                      <label className="block text-[11px] font-medium mb-1">Effect Type</label>
                      <select
                        value={effectType}
                    ...
                    {effectType === 'relationship' && (
                      <>
                        <div>
                          <label className="block text-[11px] font-medium mb-1">NPC ID</label>
                          <input
                            type="number"
                            value={targetNpcId}
                        ...
                        <div>
                          <label className="block text-[11px] font-medium mb-1">Field</label>
                          <select
                    ...
                    {effectType === 'arc' && (
                      <>
                        <div>
                          <label className="block text-[11px] font-medium mb-1">Arc ID</label>
                          <input
                            type="text"
                            value={arcId}
                    ...
                    {effectType === 'quest' && (
                      <>
                        <div>
                          <label className="block text-[11px] font-medium mb-1">Quest ID</label>
                          <input
                            type="text"
                            value={questId}
                    ...
                    {effectType === 'inventory' && (
                      <>
                        <div>
                          <label className="block text-[11px] font-medium mb-1">Item ID</label>
                          <input
                            type="text"
                            value={itemId}
                        ...
                        <div>
                          <label className="block text-[11px] font-medium mb-1">Quantity</label>
                          <input
                            type="number"
                            value={itemQty}
                    ...
                    <div>
                      <label className="block text-[11px] font-medium mb-1">Operation</label>
                      <select
                        value={effectOp}
                      ...
                      >
                        ...
                        {(effectType === 'arc' || effectType === 'inventory') && (
