...
function PropertySlider({
  ...
  return (
    <div className="flex items-center gap-2">
      <label className="text-sm text-neutral-600 dark:text-neutral-400 w-24">
        {label}:
      </label>
      <input
        type="range"
...
function ZoneEditor({ zoneId }: { zoneId: string }) {
  ...
  const removeZoneStatModifier = useModel3DStore(
    (s) => s.removeZoneStatModifier,
  );
    ...
    <div className="space-y-3 p-3 bg-neutral-50 dark:bg-neutral-900 rounded border border-neutral-200 dark:border-neutral-700">
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          onChange={(e) =>
            updateZoneProperty(zoneId, "highlightColor", e.target.value)
          }
      ...
      <div className="space-y-2">
        ...
        {config.statModifiers &&
          Object.entries(config.statModifiers).map(([stat, value]) => (
            <div key={stat} className="flex items-center gap-2 ml-4">
              ...
              <input
                ...
                step={0.1}
                onChange={(e) =>
                  addZoneStatModifier(zoneId, stat, parseFloat(e.target.value))
                }
  ...
  return (
    ...
    >
      ...
      <div className="text-sm text-neutral-600 dark:text-neutral-400">
        {isLoading
          ? "Loading model..."
          : "Drop glTF/GLB file or click to browse"}
      </div>
    </div>
  );
}
              ...
              <>
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    min={0.1}
                    onChange={(e) =>
                      setModelScale(parseFloat(e.target.value) || 1)
                    }
