 ...
 *
 * Modal dialog for saving a progression arc as a reusable template.
 * Extracted from ProgressionArcEditor.tsx.
 */
...
export function SaveArcTemplateModal({ arc, onClose }: SaveArcTemplateModalProps) {
  ...
  const [validationResult] = useState(validateArcForTemplate(arc));
