 ...
 *
 * Control Center selection and keyboard shortcuts.
 */
...
/** Control Center selection sub-section */
...
/** Cube system overview sub-section */
function CubeSystemSettings() {
  ...
  return (
    <div className="flex-1 overflow-auto p-4 space-y-4 text-xs text-neutral-800 dark:text-neutral-100">
      ...
      <div className="border border-neutral-200 dark:border-neutral-800 rounded-md p-3 bg-neutral-50/60 dark:bg-neutral-900/40">
        <div className="text-[11px] font-semibold mb-2">Cube Actions Overview</div>
...
function ShortcutsSettings() {
  return (
    <div className="flex-1 overflow-auto p-4 space-y-4 text-xs text-neutral-800 dark:text-neutral-100">
      ...
      <ul className="text-[11px] text-neutral-700 dark:text-neutral-200 space-y-1.5">
        <li className="flex items-center gap-2">
          <span className="font-mono bg-neutral-100 dark:bg-neutral-800 px-1.5 py-0.5 rounded text-[10px]">
            Ctrl+Space
          </span>
          <span>Toggle cube system (summon / dismiss)</span>
        </li>
        <li className="flex items-center gap-2">
          <span className="font-mono bg-neutral-100 dark:bg-neutral-800 px-1.5 py-0.5 rounded text-[10px]">
            Ctrl+Shift+C
          </span>
          <span>Add control cube</span>
        </li>
        <li className="flex items-center gap-2">
          <span className="font-mono bg-neutral-100 dark:bg-neutral-800 px-1.5 py-0.5 rounded text-[10px]">
            Ctrl+Shift+P
          </span>
          <span>Add provider cube</span>
        </li>
        <li className="flex items-center gap-2">
          <span className="font-mono bg-neutral-100 dark:bg-neutral-800 px-1.5 py-0.5 rounded text-[10px]">
            Arrow keys
          </span>
          <span>Rotate active cube to top / bottom / left / right face</span>
        </li>
        <li className="flex items-center gap-2">
          <span className="font-mono bg-neutral-100 dark:bg-neutral-800 px-1.5 py-0.5 rounded text-[10px]">
            R
          </span>
          <span>Toggle auto‑rotation on active cube</span>
        </li>
        <li className="flex items-center gap-2">
          <span className="font-mono bg-neutral-100 dark:bg-neutral-800 px-1.5 py-0.5 rounded text-[10px]">
            E
          </span>
          <span>Expand / collapse active cube</span>
        </li>
      </ul>
...
/** Default component - shows all sections */
  ...
  subSections: [
    {
      ...
      icon: '🎛️',
      component: ControlCenterSettings,
    },
    {
      id: 'cubes',
      label: 'Cube System',
      icon: '🎲',
      component: CubeSystemSettings,
    },
    {
      id: 'shortcuts',
      label: 'Shortcuts',
