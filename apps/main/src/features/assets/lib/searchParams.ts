...
export function buildAssetSearchRequest(
  ...
  return {
    ...
    similar_prompt_version_id: filters.similar_prompt_version_id || undefined,
    prompt_similarity_threshold: filters.prompt_similarity_threshold,
