...
const FILTER_UI_CONFIG: Record<string, { icon?: string; order?: number; overflow?: boolean; label?: string }> = {
  ...
  signal_likely_broken: { icon: 'alertTriangle', order: 84, overflow: true, label: 'Likely broken' },
  signal_borderline: { icon: 'alertCircle', order: 85, overflow: true, label: 'Borderline' },
  signal_likely_clean: { icon: 'checkCircle', order: 86, overflow: true, label: 'Likely clean' },
  signal_overridden: { icon: 'checkSquare', order: 87, overflow: true, label: 'Reviewed' },
  signal_override_clean: { icon: 'check', order: 88, label: 'Kept (clean)' },
  signal_override_broken: { icon: 'flag', order: 89, label: 'Flagged (broken)' },
