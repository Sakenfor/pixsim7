...
#FocalLengthValues: ["normal", "wide_angle", "telephoto", "macro", "fisheye", "anamorphic"]
#TempoValues: ["real_time", "slow_motion", "time_lapse", "speed_ramp", "freeze_frame", "bullet_time"]
