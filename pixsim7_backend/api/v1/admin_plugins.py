...
from pixsim7_backend.infrastructure.plugins.observability import metrics_tracker
from pixsim7_backend.infrastructure.plugins.behavior_registry import behavior_registry
from pixsim7_backend.infrastructure.plugins.manager import PluginManager
