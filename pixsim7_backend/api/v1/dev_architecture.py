...
from pixsim7_backend.api.dependencies import get_database, get_current_user_optional
from pixsim7_backend.domain.user.models import User
...
def discover_capabilities() -> List[Dict[str, Any]]:
    ...
    capabilities_dir = Path("pixsim7_backend/infrastructure/plugins/capabilities")
...
def discover_services() -> List[Dict[str, Any]]:
    ...
    services_dir = Path("pixsim7_backend/services")
...
def discover_plugin_manifests() -> List[Dict[str, Any]]:
    ...
    routes_dir = Path("pixsim7_backend/routes")
