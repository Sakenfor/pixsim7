...
from pixsim7_backend.domain.character_integrations import CharacterNPCLink, CharacterInstance
from pixsim7_backend.domain.game.models import GameNPC, NPCState
