...
| Arc Graph Editor | `/arc-graph`, `/graph/:id` | `NPC_RESPONSE_GRAPH_DESIGN.md` | `features/graph/` | `api.v1.action_blocks`, `api.v1.game_scenes`, `api.v1.character_graph` |
...
| Prompt Lab | `/dev/prompt-lab` | `SEMANTIC_PACKS_IMPLEMENTATION.md`, `PROMPT_SYSTEM_REVIEW.md` | `features/devtools/`, `features/prompts/` | `api.v1.prompts`, `api.v1.semantic_packs`, `api.v1.dev_prompt_categories` |
...
| `useIconSettingsStore` | icons | `features/icons/stores/iconSettingsStore.ts` |
...
| `useThemeSettingsStore` | theme | `features/theme/stores/themeStore.ts` |
| `useContextMenuHistoryStore` | workspace | `features/workspace/stores/contextMenuHistoryStore.ts` |
| `useWorkspaceStore` | workspace | `features/workspace/stores/workspaceStore.ts` |
<!-- STORES:END -->
...
| `useCuratorGalleryController` | gallery | `features/gallery/hooks/useCuratorGalleryController.ts` |
...
| `usePanelActions` | panels | `features/panels/hooks/usePanelManager.ts` |
| `usePanelActions` | panels | `features/panels/lib/actions.ts` |
...
| `useApplyTheme` | theme | `features/theme/useApplyTheme.ts` |
