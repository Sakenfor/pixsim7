...
Task: `room-nav-v1`  
Date: March 10, 2026  
Primary plan ID: `pseudo-3d-checkpoint-navigation` (`GET /api/v1/dev/plans/pseudo-3d-checkpoint-navigation`)
...
Primary reference:
- `GET /api/v1/dev/plans/pseudo-3d-checkpoint-navigation`
...
3. Docs update:
   - update plan checkpoints/notes via `PATCH /api/v1/dev/plans/update/pseudo-3d-checkpoint-navigation`
