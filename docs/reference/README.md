...
API references and technical specifications for core systems.
...
- **[CHARACTER_REGISTRY.md](./CHARACTER_REGISTRY.md)** - Character registry and management
- **[CHARACTER_LINKAGE_CONVENTIONS.md](./CHARACTER_LINKAGE_CONVENTIONS.md)** - Conventions for linking characters to templates

## Dynamic Systems

- **[DYNAMIC_NODE_TYPES.md](./DYNAMIC_NODE_TYPES.md)** - Dynamic node type system
- **[DYNAMIC_NODE_INSPECTOR.md](./DYNAMIC_NODE_INSPECTOR.md)** - Node inspector tool
