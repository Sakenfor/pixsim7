...
**Location:** `apps/main/src/lib/graph/`
...
**Location:** `apps/main/src/lib/game/interactions/`
...
**Location:** `apps/main/src/lib/game/interactions/sessionAdapter.ts`
...
_Generated by `packages/game/engine/src/utils/generatePluginDocs.ts`_
