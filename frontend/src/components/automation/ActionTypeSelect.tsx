...
const actionGroups = [
  {
    ...
    actions: [
      ...
      { type: ActionType.TYPE_TEXT, label: '⌨️ Type Text', description: 'Enter text input' },
      { type: ActionType.SWIPE, label: '👉 Swipe', description: 'Swipe gesture' },
      { type: ActionType.PRESS_BACK, label: '⬅️ Back Button', description: 'Press back button' },
  ...
  },
  {
    label: 'Control Flow',
    actions: [
      { type: ActionType.WAIT, label: '⏱️ Wait', description: 'Pause for duration' },
